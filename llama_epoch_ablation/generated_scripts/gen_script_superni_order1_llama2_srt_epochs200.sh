...
# Source: new_gainlora/gen_script_superni_order1_llama2_srt.sh
# Changes: num_train_epochs=200, RUN_NAME redirected, outputs redirected to llama_epoch_ablation.
#SBATCH -J srt-llama2-e200
#SBATCH -o srt-llama2-e200-%j.out
#SBATCH -p compute
#SBATCH -N 1
#SBATCH -t 80:00:00
#SBATCH --mem 256G
...
RUN_NAME="superni_order1_llama2_srt_epochs200"
...
echo "[DONE] All 15 tasks complete. Run: python score.py superni_order1_llama2_srt superni_order1_llama2_srt"
