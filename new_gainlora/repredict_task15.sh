...
CUDA_VISIBLE_DEVICES=0 python src/run_t5.py \
    ...
    --previous_lora_path \
        ...
        logs_and_outputs/long_order3_t5_srt/outputs/9-sst2/saved_weights,\
        logs_and_outputs/long_order3_t5_srt/outputs/10-dbpedia/saved_weights,\
        logs_and_outputs/long_order3_t5_srt/outputs/11-agnews/saved_weights,\
        logs_and_outputs/long_order3_t5_srt/outputs/12-yahoo/saved_weights,\
        logs_and_outputs/long_order3_t5_srt/outputs/13-multirc/saved_weights,\
        logs_and_outputs/long_order3_t5_srt/outputs/14-boolq/saved_weights \
