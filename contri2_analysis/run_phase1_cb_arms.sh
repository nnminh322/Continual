...
# Usage: cd new_gainlora && bash ../contri2_analysis/run_phase1_cb_arms.sh <GPU_ID> <MODEL_PATH>
# Example: cd new_gainlora && bash ../contri2_analysis/run_phase1_cb_arms.sh 0 google/flan-t5-large
# ==============================================================================
...
if [ ! -f "src/run_t5.py" ]; then
    ...
    echo "Usage: cd new_gainlora && bash ../contri2_analysis/run_phase1_cb_arms.sh <GPU_ID> <MODEL_PATH>"
    exit 1
fi
...
if [ ! -d "$MNLI_CKPT" ]; then
    ...
    echo "Run Phase 0 first: cd new_gainlora && bash ../contri2_analysis/run_phase0_mnli.sh $GPU_ID $MODEL_PATH"
    exit 1
fi
